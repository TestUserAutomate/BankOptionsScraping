...
public class BankNifty {
	...
	public static void main(String[] args) throws InterruptedException, SQLException {
        ...
        String Pe_35400_val =Pe_35400.substring(1,7);
        ...
        String Pe_35600_val =Pe_35600.substring(1,7);
        ...
        String Pe_35800_val =Pe_35800.substring(1,7);
        ...
        String Pe_36000_val =Pe_36000.substring(1,7);
        ...
        String Pe_36200_val =Pe_36200.substring(1,7);
        ...
        String Ce_38600_val=Ce_38600.substring(1,9);
        Ce_35000_val =Ce_35000_val.replaceAll("[-+^,]*", " ");
        Ce_35000_val =Ce_35000_val.replaceAll("\\s","");
        float Ce_35000_flt = Float.parseFloat(Ce_35000_val);
